        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            ...
            <div className="flex items-center justify-center md:justify-start gap-3">
              <a target="_blank"
                rel="noopener noreferrer" href="https://linkedin.com/company/niddik" className="text-gray-400 hover:text-blue-700 transition-colors">
                <Linkedin className="h-5 w-5" />
              </a>
              <a target="_blank"
                rel="noopener noreferrer" href="https://www.youtube.com/@NiddikkareLLP" className="text-gray-400 hover:text-red-600 transition-colors">
