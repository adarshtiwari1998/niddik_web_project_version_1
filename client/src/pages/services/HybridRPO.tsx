...
import { 
  PieChart, CheckCircle, ArrowLeft
} from 'lucide-react';
                ...
                {service.processSteps.map((step, index) => (
                  ...
                  >
                    <div className="flex-none mr-8">
                      <div className="w-8 h-8 rounded-full flex items-center justify-center bg-green-500 text-white font-bold text-xl">
                        {index + 1}
                      </div>
                    </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {service.useCases.map((useCase, index) => (
                  ...
                  >
                    <h3 className="text-xl font-semibold mb-3 text-green-600">{useCase.title}</h3>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8">
                {service.benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 mr-3 mt-1 w-6 h-6 rounded-full flex items-center justify-center bg-green-100 text-green-600">
