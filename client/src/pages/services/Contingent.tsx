                  ...
                  <ul className="space-y-3">
                    {service.benefits.slice(0, 4).map((benefit, index) => (
                      <li key={index} className="flex items-start">
                        <CheckCircle className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5 text-amber-500" />
                        <span>{benefit}</span>
                      </li>
                    ))}
                  </ul>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="absolute left-[1.625rem] top-0 bottom-0 w-[2px] -z-10">
                  <div className="h-full bg-amber-200"></div>
                </div>
                ...
                {service.processSteps.map((step, index) => (
                  ...
                  >
                    <div className="flex-none mr-8">
                      <div className="w-8 h-8 rounded-full flex items-center justify-center bg-amber-500 text-white font-bold text-xl">
                        {index + 1}
                      </div>
                    </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {service.useCases.map((useCase, index) => (
                  ...
                  >
                    <h3 className="text-xl font-semibold mb-3 text-amber-600">{useCase.title}</h3>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8">
                {service.benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 mr-3 mt-1 w-6 h-6 rounded-full flex items-center justify-center bg-amber-100 text-amber-600">
